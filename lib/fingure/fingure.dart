...
class MyFingurePage extends StatefulWidget {
  // MyLoginPage({Key key}) : super(key: key);
  const MyFingurePage({super.key, required this.title});
  final String title;
  @override
  _MyFingurePageState createState() => _MyFingurePageState();
}

class _MyFingurePageState extends State<MyFingurePage> {
